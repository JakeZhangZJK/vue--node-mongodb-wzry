   ...
   <!-- 导航区 -->
    ...
    <el-card>
       <el-row :gutter="20">
        ...
        <el-col :span="4">
          <el-button type="primary" @click='$router.push("/ads/create")'>
...
export default {
  components:{
    ...
    methods:{
      // 获取广告列表
      async  fetch(){
            const res = await this.$http.get(`rest/ads?pageNum=${this.pageNum}&pageSize=${this.pageSize}&query = ${this.query}`);
